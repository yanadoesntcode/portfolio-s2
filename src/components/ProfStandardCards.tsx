...
export default function LoCards({ title, introduction, method, photo1, photo2, photo3, photo4, photo5, approach, takeaways, improvements, images, hrefs }: BlogCardsProps) {
